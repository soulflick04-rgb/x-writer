...
export const HeroHunter: React.FC<HeroHunterProps> = ({
  ...
  return (
    <div className="w-full max-w-5xl mx-auto flex flex-col items-center justify-center text-center py-6 lg:py-10 px-4 space-y-7" ref={containerRef}>
      ...
      <div className="space-y-3 max-w-3xl">
        ...
        <h1 className="font-editorial text-5xl sm:text-6xl md:text-7xl text-[#221D18] dark:text-[#F8F4EE] leading-[1.08] font-normal tracking-tight">
          What story shall<br />we tell today?
        </h1>

        <p className="text-sm sm:text-base text-[#7B7163] dark:text-[#9E9283] font-normal tracking-normal pt-0.5">
          AI research. Sharp angles. Posts that connect.
        </p>
      </div>

      {/* 2. The 4 Horizontal Pill Selectors */}
      <div className="w-full max-w-4xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 relative z-20">
        ...
        <div className="relative">
          <button
            ...
            className={`w-full h-16 flex items-center justify-between px-4 rounded-2xl bg-white/85 dark:bg-[#1E1B18]/90 backdrop-blur-md border transition-all duration-200 shadow-pill-card text-left ${
          ...
          >
            <div className="flex items-center gap-3 truncate">
              <div className="w-8 h-8 rounded-xl bg-[#F6F0E6] dark:bg-[#2A241F] flex items-center justify-center text-[#5C5042] dark:text-[#D4A373] flex-shrink-0">
                <Film className="w-4 h-4" />
              </div>
              <div className="truncate">
                <span className="block text-[10px] uppercase font-mono tracking-wider text-[#9E9283]">
                  Content Type
                </span>
          ...
          {activeDropdown === 'content' && (
            <div className="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-[#1E1B18] border border-[#E5DACB] dark:border-[#3A332B] rounded-2xl p-2 shadow-editorial-card z-50 max-h-64 overflow-y-auto animate-fade-in text-left">
      ...
      <div className="w-full max-w-xl mx-auto relative z-10">
        <div className="flex items-center gap-3 px-4 py-2.5 rounded-full bg-white/80 dark:bg-[#1E1B18]/90 backdrop-blur-md border border-[#EBE3D5] dark:border-[#332D26] focus-within:border-[#C29358] focus-within:ring-2 focus-within:ring-[#C29358]/20 shadow-pill-card transition-all">
          <Sparkles className="w-3.5 h-3.5 text-[#C29358] flex-shrink-0" />
          <input
            type="text"
            placeholder="Focus on a specific movie, director, or topic... (Optional)"
            value={specificTopic || ''}
      ...
      <div className="flex flex-wrap items-center justify-center gap-4 text-xs font-medium text-[#6B6154] dark:text-[#A89C8D]">
        
        {/* Length Selector */}
        <div className="flex items-center gap-1.5 bg-white/70 dark:bg-[#1E1B18]/80 px-2.5 py-1 rounded-full border border-[#EBE3D5] dark:border-[#332D26] shadow-2xs">
          <AlignLeft className="w-3 h-3 text-[#9E9283]" />
          <span className="text-[10px] font-mono text-[#9E9283] mr-1 uppercase">Length:</span>
          {lengths.map((len) => (
            <button
              key={len}
              type="button"
        ...
        <div className="flex items-center gap-1.5 bg-white/70 dark:bg-[#1E1B18]/80 px-2.5 py-1 rounded-full border border-[#EBE3D5] dark:border-[#332D26] shadow-2xs">
          ...
          <span className="text-[10px] font-mono text-[#9E9283] mr-1 uppercase">Hashtags:</span>
      ...
      <div className="space-y-4 pt-1">
        <button
          ...
          className={`relative group inline-flex items-center justify-center gap-3 px-12 py-4 rounded-full text-sm font-bold uppercase tracking-wider transition-all duration-300 ${
      ...
      {/* 6. Footer Trust Note */}
      <div className="pt-2 flex items-center justify-center gap-2 text-[11px] text-[#9E9283] dark:text-[#7A7063] font-medium">
        <Lock className="w-3.5 h-3.5" />
        <span>Private. Secure. Yours.</span>
        <span>•</span>
        <span>No data is shared.</span>
      </div>
