...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className="w-64 h-screen fixed left-0 top-0 z-30 flex flex-col justify-between border-r border-[#E8DFCFC0] dark:border-[#2D2822] bg-[#F7F2E9]/80 dark:bg-[#181614]/90 backdrop-blur-xl p-6 transition-all">
      ...
      <div className="space-y-8">
        ...
        >
          ...
          <p className="text-[11px] text-[#8C8173] dark:text-[#9E9283] font-medium tracking-wide">
      ...
      <div className="space-y-4 pt-4 border-t border-[#E8DFCFC0]/60 dark:border-[#2D2822]">
        ...
        <div className="p-3.5 rounded-2xl bg-white/70 dark:bg-[#201D1A]/80 border border-[#E5DACB] dark:border-[#332D26] shadow-sm flex items-start gap-2.5 text-xs text-[#6B6154] dark:text-[#B5A898]">
        ...
        >
          <div className="flex items-center gap-2.5">
            ...
            <div className="text-left">
              <span className="block text-xs font-bold text-[#2A241F] dark:text-[#F3EDE6]">
                {userName}
              </span>
              <span className="block text-[10px] text-[#9E9283] font-mono">
